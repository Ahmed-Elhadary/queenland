                ...
                <form class="needs-validation " novalidate action="{{route('company_date.store')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" name="company_date"id="validationCustom02" placeholder="English name"  >
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">English Title</label>
                            <input type="text" class="form-control" name="en_title"id="validationCustom02" placeholder="English name"  >
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">Arabic Title</label>
                            <input type="text" class="form-control" name="ar_title" id="validationCustom02" placeholder="Arabic name"  required>
